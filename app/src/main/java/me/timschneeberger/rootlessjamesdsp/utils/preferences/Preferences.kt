...
class Preferences(val context: Context) {
    ...
    abstract class AbstractPreferences(val context: Context) {
        ...
        // PERFORMANCE: Throttle Crashlytics logging to reduce CPU/battery overhead
        ...
        inline fun <reified T : Any> get(@StringRes nameRes: Int, default: T): T {
            return get<T>(nameRes, default, T::class)
        }
