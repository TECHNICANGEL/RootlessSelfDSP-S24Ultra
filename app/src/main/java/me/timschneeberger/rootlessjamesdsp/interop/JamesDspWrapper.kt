...
object JamesDspWrapper {
    ...
    external fun setReverbCustom(self: JamesDspHandle, enable: Boolean, roomSize: Float, decay: Float, damping: Float, diffusion: Float, predelay: Float, wetLevel: Float, dryLevel: Float, width: Float): Boolean
    ...
    external fun setBassBoostEnhanced(self: JamesDspHandle, enable: Boolean, maxGain: Float, manualMode: Boolean, manualFreq: Float, resonance: Float, harmonicGen: Boolean, harmonicLevel: Float): Boolean
    external fun setStereoEnhancement(self: JamesDspHandle, enable: Boolean, level: Float): Boolean
    external fun setStereoEnhancementEnhanced(self: JamesDspHandle, enable: Boolean, level: Float, depth: Float, centerLevel: Float, lowMix: Float, midMix: Float, highMix: Float): Boolean
    external fun setVacuumTube(self: JamesDspHandle, enable: Boolean, drive: Float, bias: Float, mix: Float, evenHarm: Float, oddHarm: Float): Boolean
