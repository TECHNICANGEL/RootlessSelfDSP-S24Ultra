namespace ViPERToolBox
{
    ...
    public class frmAddPoint : Form
    {
        ...
        public frmAddPoint(MUI.MUIContent mcMUIContent)
        {
        ...
        private void button_OK_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(this.g_mcMUIContent.Tip_Text_Invalid_Frequency, this.g_mcMUIContent.AddPointFormTitle, MessageBoxButtons.OK, MessageBoxIcon.Hand);
            }
            else if (this.textBox_Bandwidth.Text.Length <= 0)
            {
                MessageBox.Show(this.g_mcMUIContent.Tip_Text_Invalid_Bandwidth, this.g_mcMUIContent.AddPointFormTitle, MessageBoxButtons.OK, MessageBoxIcon.Hand);
            }
            else if (this.textBox_Gain.Text.Length <= 0)
            {
                MessageBox.Show(this.g_mcMUIContent.Tip_Text_Invalid_Gain, this.g_mcMUIContent.AddPointFormTitle, MessageBoxButtons.OK, MessageBoxIcon.Hand);
            }
        ...
        {
            this.Text = this.g_mcMUIContent.AddPointFormTitle;
