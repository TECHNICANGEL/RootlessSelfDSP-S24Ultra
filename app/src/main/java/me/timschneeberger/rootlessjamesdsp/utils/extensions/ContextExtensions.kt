...
object ContextExtensions {
    ...
    // S24 ULTRA: Added "DSP ULTRA" (RFNQIFVMVFJB) to allowed app names
    private val APPNAME_REFS = setOf("Um9vdGxlc3NKYW1lc0RTUA==", "SmFtZXNEU1A=", "RFNQIFVMVFJB")
    ...
    /**
     * Dismiss dialog with a small delay to allow SurfaceFlinger buffers to drain.
     * This prevents "Could not call release buffer callback" errors during dialog transitions.
     */
    private fun DialogInterface.dismissWithBufferDrain() {
        ...
        }, 50) // 50ms = ~3 frames at 60fps, allows buffer queue to drain
    }
