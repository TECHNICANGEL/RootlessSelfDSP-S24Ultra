...
class GraphicEqNodeAdapter(var nodes: GraphicEqNodeList) :
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ViewHolder {
        ...
        // PERFORMANCE: Set click listeners once in onCreateViewHolder instead of onBindViewHolder
        // This avoids creating new lambda objects on every bind
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        // PERFORMANCE: Click listeners are set once in onCreateViewHolder
    }
