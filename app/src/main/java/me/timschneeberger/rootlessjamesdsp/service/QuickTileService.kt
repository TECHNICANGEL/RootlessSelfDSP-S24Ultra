...
class QuickTileService : TileService(),
    ...
    override fun onClick() {
        ...
        toggleEnginePower(toggled) { intent ->
            // S24 ULTRA: Ensure proper activity launch flags
            intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)

            val pending = PendingIntent.getActivity(app, 0, intent, PendingIntent.FLAG_IMMUTABLE or PendingIntent.FLAG_UPDATE_CURRENT)

            // S24 ULTRA: Android 15+ always uses pending intent method
