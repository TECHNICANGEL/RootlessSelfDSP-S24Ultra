...
class AppCompatibilityFragment : Fragment() {
    ...
    // MEMORY LEAK FIX: Store handler as member to allow cleanup
    ...
    override fun onCreateView(
        ...
        // PERFORMANCE: Use Handler instead of Timer to avoid memory leaks from thread creation
    ...
    override fun onDestroyView() {
        // MEMORY LEAK FIX: Remove all pending callbacks
